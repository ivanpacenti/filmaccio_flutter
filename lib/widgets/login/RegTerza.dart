        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => RegSeconda(userData: userData)),
            );
          },
        ),
        title: Align(
            ...
            Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle:
                        TextStyle(color: !nomeCorretto ? Colors.red : null),
                    ...
                    suffixIcon: IconButton(
                      ...
                      icon: Icon(
                          nomeCorretto ? Icons.clear : Icons.warning_amber,
                          color: !nomeCorretto ? Colors.red : null),
                    ),
                  ),
                  maxLength: 80,
                ...
                if (lunghezza < 3 || lunghezza > 50) {
                  setState(() {
                    ...
                    Fluttertoast.showToast(
                        msg:
                            "Il nome visualizzato deve essere tra i 3 e i 50 caratteri",
